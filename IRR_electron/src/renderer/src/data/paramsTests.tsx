...
const tests: Test[] = [
  {
    ...
    TestSuccessCondition:
      'El usuario decidirá si la prueba se pasó con éxito.',
  ...
  },
  {
    ...
    TestFailCondition:
      'La prueba solo se considerara fallida si el servicio de la cámara no se encuentra activo, o si el usuario decide que no pasó la prueba.',
