...
const tests: Test[] = [
  ...
  //   TestFailCondition:
  //     'Esta prueba esta condicionada a intentos, si mientras se reproduce el audio los audifonos sufren desconexiones, la prueba solo se reiniciara si se conectan denuevo los audifonos y se perdera un intento, si se pierden todos los intentos, la prueba se dara por fallida.',
