...
const tests: Test[] = [
  {
    ...
    TestFailCondition:
      'La prueba solo se considerara fallida si si acaba el tiempo y el usuario determina que no paso la prueba',
  ...
  },
  {
    ...
    TestFailCondition:
      'La prueba solo se dara por fallida si al mostrarse la ventana emergente el usuario determina que no paso la prueba',
  ...
  },
  {
    ...
    TestFailCondition:
      'La prueba solo se considerara fallida si no se completan las dos fases de la prueba en el tiempo establecido y si al salir la ventana el usuario determina que no paso la prueba.',
  ...
  },
  {
    ...
    TestDescription:
      'La prueba consiste en verificar si la salida de audio esta funcionando correctamente, para ello se intentara reproducir un audio durante un tiempo determinado; primero se reproducirar por las bocinas del dispositivo, y se le pedira al usuario que conecte los audifonos para que se reproduzca el audio por estos.',
    TestSuccessCondition:
    ...
    TestNotes: [
      ...
      'Al final del tiempo establecido, aparecera una ventana para que el usuario determine si paso la prueba o no'
    ],
    TestTimer: 0,
    TestTries: 3
  },
  ...
  },
  {
    ...
    TestSuccessCondition:
      'Una vez el termine proceso se pasara a la siguiente prueba con el mensaje de exito si no hubo ningun problema durante el proceso.',
