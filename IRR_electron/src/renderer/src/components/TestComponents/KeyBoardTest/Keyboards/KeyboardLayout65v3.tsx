...
export default function KeyboardLayout65v3({ handleKeyDown }) {
  return (
    <div className="grid grid-cols-[70rem] gap-2 ">
      <div className="grid grid-rows-6 gap-2">
        ...
        <div className="grid grid-cols-[repeat(16,1fr)] gap-2">
          ...
          <div className="col-span-2">
            <ButtonKey label="Backspace" code={'Backspace'} handleKeyDown={() => handleKeyDown()} />
          </div>
        ...
        <div className="grid grid-cols-[repeat(15,1fr)] gap-2">
          <ButtonKey label="CapsLock" code={'CapsLock'} handleKeyDown={() => handleKeyDown()} />
        ...
        <div className="grid grid-cols-[repeat(16,1fr)] gap-2">
          ...
          <div className="col-span-3">
            <ButtonKey label="Shift" code={'ShiftRight'} handleKeyDown={() => handleKeyDown()} />
          </div>
        ...
        <div className="grid w-full grid-cols-[repeat(4,1fr),500px,repeat(5,1fr)] grid-rows-2 gap-2">
          <div className="row-span-2">
            <ButtonKey label="Ctrl" code={'ControlLeft'} handleKeyDown={() => handleKeyDown()} />
          </div>
          <div className="row-span-2">
            <ButtonKey code={'none'} label="FN" handleKeyDown={() => handleKeyDown()} />
          </div>
          <div className="row-span-2">
          ...
          <div className="row-span-2">
            <ButtonKey label="Ctrl" code={'ControlRight'} handleKeyDown={() => handleKeyDown()} />
          </div>
          <div className="row-span-2">
