            ...
            <CardBody className=" max-w-[60rem]">
                ...
                >
                    <motion.li variants={item}>
                       <div className="border-[7px] p-2 px-3 border-black" >
                         <LuHdmiPort size={150} />
                       </div>
                    </motion.li>
                    <h1 className="font-bold text-text-700 text-xl underline text-center">Por favor, conecte el cable HDMI al puerto correspondiente y elija la opción según si se muestra vídeo.</h1>
                    <div className="flex justify-center gap-4 bg-secondary-200 p-2 rounded-md">
                        <Button
